    ...
    <section id="team" className="py-16">
      ...
      <div className="grid max-w-sm grid-cols-1 gap-6 mx-auto md:hidden">
        {members.map((m) => {
          ...
          return (
            <div key={m.id} className="p-6 text-center bg-white rounded-lg shadow-lg">
      ...
      <div className="relative hidden max-w-6xl mx-auto overflow-hidden text-center md:block">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-0 z-10 items-center justify-center hidden p-3 -translate-y-1/2 rounded-full shadow cursor-pointer md:flex rtl:left-auto rtl:right-0 top-1/2 bg-white/80 hover:bg-white"
        >
            ...
            return (
              <div key={m.id} className="w-1/3 px-4 shrink-0">
                <div className="p-6 text-center bg-white rounded-lg shadow-lg">
                  <div className="relative w-48 h-48 mx-auto mb-4 overflow-hidden rounded-md">
                    {img && (
                      <Image
                        fill
                        src={img}
        ...
        <button
          onClick={nextSlide}
          className="absolute right-0 z-10 items-center justify-center hidden p-3 -translate-y-1/2 rounded-full shadow cursor-pointer md:flex rtl:right-auto rtl:left-0 top-1/2 bg-white/80 hover:bg-white"
        >
          <span className="text-2xl rtl:hidden">&gt;</span>
          <span className="hidden text-2xl rtl:inline">&lt;</span>
        </button>
