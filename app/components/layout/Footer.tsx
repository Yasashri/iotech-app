  ...
  return (
    <footer className="mt-10 text-white bg-background-brown">
      <div className="max-w-6xl px-4 py-8 mx-auto">
        ...
        <div className="flex flex-col items-start justify-between gap-4 pt-4 text-sm md:flex-row md:items-center">
          <nav className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-6">
